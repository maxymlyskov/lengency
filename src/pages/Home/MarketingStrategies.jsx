  ...
  const strategies = [
    {
      ...
      image:"https://sheygency.netlify.app/images/content-marketing.png"
    },
    {
      title:'INBOUND MARKETING',
      description:"Inbound is far and away the most effective B2B marketing strategy because it leverages the strengths of the majority of the other nine strategies to attract, engage, and delight customers.",
      image:"https://sheygency.netlify.app/images/inbound-marketing.png"
    },
    {
      title:'SOCIAL MEDIA',
      description:"Social media marketing focuses on providing users with content they find valuable and want to share across their social networks, resulting in increased visibility and website traffic.",
      image:"https://sheygency.netlify.app/images/social-media.png"
    },
    {
      ...
      image:'https://sheygency.netlify.app/images/seo.png'
    }
  ]
  return (
    <div>
